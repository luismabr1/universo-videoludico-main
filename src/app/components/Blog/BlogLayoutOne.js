                ...
                <div className='w-full absolute bottom-0 p-10 z-20'>
                    ...
                    <Link href={blog.url} className='mt-6'>
                        <h2 className='font-bold capitalize text-2xl text-light mt-4'>
                            <span className='bg-gradient-to-r from-accent to-accent bg-[length:0px_6px] group-hover:bg-[length:100%_6px] bg-bottom bg-no-repeat transition-[background-size] duration-500'>{blog.title}</span>
                        </h2>
                    </Link>
                </div>
        </div>
